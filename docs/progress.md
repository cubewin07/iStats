...
| Next task | `3.6` Validate vs reference tools + Phase 3 report |
| Last closed | **3.5** Network/disk in detail view + bytes/bits option |
| Blocked by | — |
...
| 3 | Network & disk | in progress | After Phase 1. |
