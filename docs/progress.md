...
| Next task | `4.2` Battery health metrics |
| Last closed | **4.1** PowerSampler: charge / state / time remaining |
| Blocked by | — |
...
| 4 | Battery & power | in progress | Charge, state, time-remaining, health, and power draw. |
